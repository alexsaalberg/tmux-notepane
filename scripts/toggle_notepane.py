...
def create_notepane(pane):	
	...
	#pane.display_message("mainpane")
	#print(get_id_from_pane(pane) + " just spawned " + get_id_from_pane(note_pane) )
	leaf_pid = get_leaf_pid(get_pid(pane))
	note_pane.send_keys("tldr "+get_program_from_pid(leaf_pid))
